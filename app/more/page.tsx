...
import { Boxes, ChevronRight, ClipboardList, FileText, History, Landmark, MessageCircle, Palette, Settings, SlidersHorizontal, Users, UserRoundCog, CircleUserRound, ArrowDownUp, BookOpen } from "lucide-react";
...
const menus = [
  ...
  [BookOpen, "Panduan", "Video tutorial & link referensi", "/panduan"],
] as const;
...
export default async function MorePage() {
  ...
  return <AppShell>
    ...
    <div className="buildNote"><strong>iMersOrders Cloud v1.0.0</strong><span>CRUD ✓ · Quick Customer ✓ · Auto SKU ✓ · 10 Tema ✓ · Hutang & Piutang Pribadi ✓</span></div>
  </AppShell>;
}
