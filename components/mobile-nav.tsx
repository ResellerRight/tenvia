...
const moreRoutes = ["/more","/customers","/catalog","/invoices","/custom-fields","/payment-methods","/message-templates","/settings","/team","/reports","/activity","/whatsapp","/account","/appearance","/panduan"];
